...
void sendSensorValue() {
  ...
  // Display Info
  Display.clearBuffer();
  Display.setCursor(0, 12); Display.print("Enviando");
  Display.setCursor(0, 30); Display.print("Paquete:");
  Display.setCursor(0, 48); Display.print("value: " + (String)sensor1);
  Display.sendBuffer();
  delay(5000);
  waitingResponse();
}
  ...
  while (waiting) 
  {
    ...
    }else
    {
      ...
      if (packetSize)
      {
        ...
        // Display Info
        Display.clearBuffer();
        Display.setCursor(0, 12); Display.print("Confirmado");
        Display.setCursor(0, 42); Display.print("    '" + (String)packet + "'");
